...
<head>
    ...
    <link href="{{ asset('css/Inicio.css?v=1.0') }}" rel="stylesheet">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="row" id="FondoP1">
            <div class="col-12 col-md-4 text-center">
                <img class="Pf img-fluid" src="/img/logoColor.png" alt="Logo">
            </div>
                ...
                <div class="info-section mb-4">
                    ...
                    <div class="d-flex align-items-center mt-3">
                        <div class="icon-circle me-3">
                            <img class="bac" src="/img/bacterias.png" alt="Logo">
                ...
                <div class="info-section">
                    ...
                    <div class="mt-3 ">
                        ...
                        <div class="text-center mt-3">
                            <img class="tos" src="/img/tos.png" alt="Logo">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="info-section mb-4">
                    ...
                    <div class="d-flex mt-3">
                        <div class="symptom-icon me-4">
                            <img class="sin"  src="/img/medico.png" alt="Logo">
                ...
                <div class="info-section">
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <img class="sin"  src="/img/tableta.png" alt="Logo">
                        </div>
                        <div>
                            <ul id="text" class="list-unstyled">
