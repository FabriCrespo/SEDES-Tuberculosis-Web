...
<head>
    ...
    <link href="{{ asset('css/registro-pacientes.css?v=1.0') }}" rel="stylesheet">
</head>
<body>    
    <div class="page-container">
        <div class="container">
            <div class="registration-header">
                <img src="/images/logotuberculosis.png" alt="Logo" class="registration-logo">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Hacer una solicitud a la API para obtener las sedes
        fetch('api/sedes')
            ...
            .then(data => {
                ...
                // Recorrer los datos recibidos y agregar opciones al select
                data.forEach(sede => {
                    let option = document.createElement('option');
                    option.value = sede.id;  // Usa el ID como valor
                    option.textContent = sede.nombre; // Usa el nombre de la sede como texto
